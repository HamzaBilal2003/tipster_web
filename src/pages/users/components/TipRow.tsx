...
const TipRow: React.FC<TipRowProps> = ({ displayData, index, onViewTip }) => {
    return (
        ...
        >
            ...
            {/* Category */}
            <td className="px-4 py-2 text-black">{displayData.category || "Sports"}</td>
            ...
            {/* Status */}
            <td className="px-4 py-2">
                <div className={`text-center capitalize gap-2 p-1 px-2 rounded-full ${
            ...
            {/* Approval */}
            <td className="px-4 py-2">
                <div className={`flex items-center capitalize gap-2 p-1 px-2 rounded-full ${
                    displayData.approval ? "text-green-500" : "text-[#FFA500]"
                }`}>
                    {displayData.approval ? "Approved" : "Pending"}
                </div>
            </td>
